...
export async function sendCoachAthleteInviteEmail(options: {
  ...
  const subject = `${coachName} invited you to Journey Endurance Coaching`
  const html = `
    <div style="font-family: Inter, Arial, sans-serif; color: #111827; line-height: 1.6; max-width: 560px; margin: 0 auto; padding: 24px;">
      ...
      <p style="margin: 0 0 24px; color: #4b5563;">
        Open the invitation below to connect your athlete account with your coach inside Journey Endurance Coaching.
      </p>
