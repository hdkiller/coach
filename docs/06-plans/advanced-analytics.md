...
*   **`detectSurgesAndFades`**:
    ...
    *   **Logic**: Identify segments where Power > 120% FTP for > 5s. For each surge, calculate the average power of the *subsequent* 30-60s to measure the "fade" or "recovery cost".
