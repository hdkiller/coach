...
type IngestWhoopPayload = {
  userId: string
  startDate: string
  endDate: string
}

export async function runIngestWhoop(payload: IngestWhoopPayload): Promise<IngestionResult> {
...
registerTaskHandler('ingest-whoop', runIngestWhoop)
