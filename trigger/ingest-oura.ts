...
type IngestOuraPayload = {
  userId: string
  startDate: string
  endDate: string
}

export async function runIngestOura(payload: IngestOuraPayload): Promise<IngestionResult> {
...
registerTaskHandler('ingest-oura', runIngestOura)
