...
export async function runRecommendTodayActivity(payload: {
  userId: string
  date: Date
...
registerTaskHandler('recommend-today-activity', runRecommendTodayActivity)
...
export const recommendTodayActivityTask = task({
  ...
  run: async (payload: {
    ...
    return runRecommendTodayActivity(payload)
  }
})
