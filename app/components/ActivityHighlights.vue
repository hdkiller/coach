<template>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    <!-- Total Distance -->
    <UCard class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-l-4 border-l-blue-500">
      <div class="flex flex-col">
        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Total Distance</span>
    ...
    <!-- Total Duration -->
    <UCard class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-l-4 border-l-green-500">
      <div class="flex flex-col">
        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Total Duration</span>
        <div class="flex items-end gap-2">
          <span class="text-2xl font-bold text-gray-900 dark:text-white">
    ...
    <!-- TSS Accumulation -->
    <UCard class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-l-4 border-l-purple-500">
      <div class="flex flex-col">
        <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Training Load (TSS)</span>
        <div class="flex items-end gap-2">
          <span class="text-2xl font-bold text-gray-900 dark:text-white">
    ...
    <!-- Workload Ratio (ACWR) -->
    <UCard :class="['bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-l-4', getACWRColorClass(data?.load.workloadRatio)]">
      <div class="flex flex-col">
        <div class="flex justify-between items-start">
          <span class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Load Ratio (ACWR)</span>
          <UTooltip text="Acute:Chronic Workload Ratio. 0.8-1.3 is optimal. >1.5 indicates high injury risk.">
