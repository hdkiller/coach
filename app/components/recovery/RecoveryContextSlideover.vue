...
<script setup lang="ts">
  ...
  async function handleSave() {
    ...
    try {
      if (createMode.value) {
        await (globalThis.$fetch as any)('/api/recovery-context/journey', {
          method: 'POST',
          body: {
        ...
        await (globalThis.$fetch as any)(`/api/checkin/${selectedItem.value.sourceRecordId}`, {
          method: 'PATCH',
          body: {
