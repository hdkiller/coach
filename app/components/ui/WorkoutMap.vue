<template>
  <div class="h-96 w-full rounded-xl overflow-hidden ring-1 ring-gray-200 dark:ring-gray-800 z-0 bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
    <client-only>
      <LMap
...
const endPoint = computed(() => latLngs.value.length > 0 ? latLngs.value[latLngs.value.length - 1] : null)
