      ...
      <UCard>
        ...
        <div class="space-y-2">
          <template v-if="editingZones === 'hr'">
            <div
              v-for="(zone, index) in localHrZones"
              :key="index"
            ...
            <div class="flex justify-end gap-2 mt-2">
              <UButton size="xs" color="neutral" variant="ghost" @click="editingZones = null"
                >Cancel</UButton
              >
          ...
          <template v-else>
            <div
              v-for="(zone, index) in localHrZones"
              :key="index"
              class="flex items-center justify-between text-sm py-1 border-b dark:border-gray-700 last:border-0"
            >
      ...
      <UCard>
        ...
        <div class="space-y-2">
          <template v-if="editingZones === 'power'">
            <div
              v-for="(zone, index) in localPowerZones"
              :key="index"
              class="flex items-center gap-2 py-1"
            >
