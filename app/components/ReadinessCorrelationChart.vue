<template>
  <div class="readiness-correlation-chart">
    ...
    <div v-else-if="!chartData || !chartData.datasets[0] || chartData.datasets[0].data.length === 0" class="text-center py-12">
    ...
    <div v-else class="space-y-6">
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300">Readiness vs Training Load</h3>
