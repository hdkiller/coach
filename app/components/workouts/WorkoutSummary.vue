  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
    <UCard :ui="{ body: 'p-3 sm:p-6' }" class="bg-blue-50 dark:bg-blue-900/20 ring-blue-500/10">
      <div class="text-center space-y-1">
        ...
        <div
          class="text-[10px] font-bold text-blue-900/60 dark:text-blue-400/60 uppercase tracking-widest px-1"
        >
          Total Workouts
        </div>
      </div>
    ...
    >
      <div class="text-center space-y-1">
        ...
        <div
          class="text-[10px] font-bold text-emerald-900/60 dark:text-emerald-400/60 uppercase tracking-widest px-1"
        >
          AI Analyzed
        </div>
      </div>
    ...
    >
      <div class="text-center space-y-1">
        ...
        <div
          class="text-[10px] font-bold text-purple-900/60 dark:text-purple-400/60 uppercase tracking-widest px-1"
        >
          Total Volume
        </div>
      </div>
