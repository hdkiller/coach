...
<template>
  <EHtml lang="en">
    ...
    <EPreview>
      {{ workoutTitle }} is synced. {{ quickTakeLabel || 'Session logged' }}
      ...
      >
        ...
        <ESection style="padding: 32px 40px">
          <EHeading
            ...
            "
          >
            Your workout is synced and ready to review.
          </EHeading>
          ...
          <EText style="font-size: 16px; line-height: 1.6; color: #71717a; margin-bottom: 20px">
            We added your latest workout to your timeline:
          ...
          <EText style="font-size: 15px; line-height: 1.6; color: #71717a; margin: 0 0 20px">
            Open your workout details to review splits, heart rate, power, and training load while
          ...
          >
            ...
            <EText v-if="elevationGain" style="font-size: 14px; margin: 0 0 8px; color: #52525b">
              <strong style="color: #09090b">Elevation Gain:</strong> {{ elevationGain }} m
            </EText>
            ...
            <EText v-if="calories" style="font-size: 14px; margin: 0; color: #52525b">
              <strong style="color: #09090b">Calories:</strong> {{ calories }} kcal
            </EText>
          </EContainer>
