  ...
  <div class="space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-start gap-3">
          <div class="p-2 bg-neutral-50 dark:bg-neutral-900/20 rounded-lg shrink-0">
            <UIcon name="i-heroicons-list-bullet" class="w-6 h-6 text-neutral-600 dark:text-neutral-400" />
          </div>
          <div class="min-w-0">
        ...
        <div class="flex flex-wrap gap-2">
          <UButton to="/settings/changelog" color="neutral" variant="outline" icon="i-heroicons-list-bullet" size="sm"
            class="font-bold shrink-0">
            View Changelog
          </UButton>
          <UButton to="/settings/release-notes" color="neutral" variant="outline" icon="i-heroicons-sparkles" size="sm"
            class="font-bold shrink-0">
            View Release Notes
          </UButton>
        </div>
    ...
    <UCard>
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <UButton to="/_docs/scalar" target="_blank" color="neutral" variant="outline"
          icon="i-heroicons-arrow-top-right-on-square" size="sm" class="font-bold shrink-0">
          View Docs
        </UButton>
      </div>
    </UCard>
    ...
    <UCard>
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <UButton to="/settings/bug-reports" color="neutral" variant="outline" icon="i-heroicons-arrow-right" size="sm"
          class="font-bold shrink-0">
          Track Issues
        </UButton>
      </div>
    ...
    <UCard>
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <UButton to="/data" color="neutral" variant="outline" icon="i-heroicons-arrow-right" size="sm"
          class="font-bold shrink-0">
          View Data
        </UButton>
      </div>
    ...
    <UCard>
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <UButton to="/developer" color="neutral" variant="outline" icon="i-heroicons-arrow-right" size="sm"
          class="font-bold shrink-0">
          Open Portal
        </UButton>
      </div>
    ...
    <UCard>
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <UButton color="primary" variant="solid" icon="i-heroicons-plus" size="sm" class="font-bold"
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="key in apiKeys" :key="key.id">
              ...
              <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                <UButton color="error" variant="ghost" icon="i-heroicons-trash" size="xs" @click="confirmDelete(key)" />
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <!-- Create Key Modal -->
    <UModal v-model:open="isCreateModalOpen" title="Create API Key"
      ...
      <template #body>
        ...
        <div v-if="generatedKey"
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="text-xs font-bold text-yellow-800 dark:text-yellow-300 uppercase tracking-tight">
                Save this key!
              </p>
          ...
          <div class="mt-3 flex items-center gap-2">
            <UInput readonly :value="generatedKey" class="flex-1 font-mono text-xs"
              :type="isKeyVisible ? 'text' : 'password'">
              <template #trailing>
                <UButton color="neutral" variant="ghost"
                  :icon="isKeyVisible ? 'i-heroicons-eye-slash' : 'i-heroicons-eye'" size="xs"
                  @click="isKeyVisible = !isKeyVisible" />
              </template>
            </UInput>
            <UButton color="neutral" variant="outline" icon="i-heroicons-clipboard" size="sm" @click="copyKey">
              Copy
            </UButton>
          </div>
        </div>
      ...
      <template #footer>
        <div class="flex justify-between w-full">
          ...
          <UButton v-if="!generatedKey" label="Create Key" color="primary" :loading="creating" @click="createKey" />
        </div>
      </template>
    </UModal>

    <!-- Delete Confirmation Modal -->
    <UModal v-model:open="isDeleteModalOpen" title="Revoke API Key"
