  ...
  <div class="py-12 sm:py-20 bg-gray-50 dark:bg-gray-950 flex-grow flex items-center">
    <UContainer class="w-full">
      ...
      >
        ...
        <div
          class="lg:col-span-5 relative bg-gray-900 text-white p-8 sm:p-12 flex flex-col justify-between"
        >
        ...
        <!-- Right: Auth Form -->
        <div
          class="lg:col-span-7 p-8 sm:p-12 flex flex-col justify-center bg-white dark:bg-gray-900"
        >
