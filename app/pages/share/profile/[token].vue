    ...
    <div v-else-if="profile" class="space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          >
            <div class="flex items-start justify-between mb-4">
              ...
              <div>
                <UBadge color="success" size="md" variant="subtle"> Public View </UBadge>
              </div>
            </div>

            <!-- Executive Summary (Quick Take style) -->
            <div
              v-if="profile.analysisJson?.executive_summary"
              class="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800"
            >
              <h3
          ...
          <div
            v-if="profile.analysisJson?.training_characteristics"
            class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700"
          >
            <h2
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <h3
                  class="text-base font-semibold text-green-900 dark:text-green-100 mb-3 flex items-center gap-2"
                >
              ...
              <div
                class="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-5 border border-orange-200 dark:border-orange-800"
              >
                <h3
                  class="text-base font-semibold text-orange-900 dark:text-orange-100 mb-3 flex items-center gap-2"
                >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Recovery Profile -->
            <div
              v-if="profile.analysisJson?.recovery_profile"
            ...
            >
              ...
              <div class="space-y-4">
                <div v-if="profile.analysisJson.recovery_profile.recovery_pattern">
                  <h4 class="text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 mb-1">
                    Recovery Pattern
                  </h4>
                ...
                <div
                  v-if="profile.analysisJson.recovery_profile.key_observations?.length"
                ...
                >
                  <ul class="space-y-2">
                    ...
                    >
                      <span
                        class="i-heroicons-chevron-right w-4 h-4 mt-0.5 text-pink-500 flex-shrink-0"
                      />
                      <span>{{ obs }}</span>
                    </li>
                  </ul>
            ...
            <!-- Nutrition Profile -->
            <div
              v-if="profile.analysisJson?.nutrition_profile"
              class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700 h-full"
            >
              <h2
                class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"
          ...
          <!-- Planning Context -->
          <div
            v-if="profile.analysisJson?.planning_context"
            class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700"
          >
            <h2
              class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"
            ...
            <div
              class="mb-4 bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg border border-indigo-100 dark:border-indigo-800"
            >
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div
            v-if="profile.analysisJson?.current_fitness"
            class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700"
          >
            <h2
              class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"
          ...
          <div
            v-if="profile.analysisJson?.recent_performance"
            class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700"
          >
            <h2
              class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"
            ...
            <div class="flex items-center justify-between mb-4">
              ...
              <UBadge
                :color="getTrendBadgeColor(profile.analysisJson.recent_performance.trend) as any"
                size="md"
              >
            ...
            <div
              ...
              class="space-y-3"
            >
              <h4 class="text-xs font-semibold uppercase text-gray-500 mt-4 mb-2">
                Notable Workouts
              </h4>
              <div
          ...
          <div
            v-if="profile.analysisJson?.recommendations_summary"
            class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700"
          >
            <h2
              class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"
...
<script setup lang="ts">
  ...
  const profile = computed(() => {
    if (
      sharedData.value?.resourceType === 'REPORT' ||
      sharedData.value?.resourceType === 'ATHLETE_PROFILE'
    ) {
