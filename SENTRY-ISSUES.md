...
| [COACH-WATTS-3J](https://newpush-y4.sentry.io/issues/COACH-WATTS-3J)   | `UnhandledRejection: value: undefined`                           | 9     | 10     | ~2h ago   | `/workouts/:id()`                | Fix in `workouts/[id]/index.vue`; still open in Sentry                                         |
| [COACH-WATTS-1DE](https://newpush-y4.sentry.io/issues/COACH-WATTS-1DE) | `PrismaClientValidationError`                                    | 0     | 1      | ~2h ago   | `summarize-chat.ts`              | **New** — investigate schema/query mismatch                                                    |
...
| [COACH-WATTS-1DD](https://newpush-y4.sentry.io/issues/COACH-WATTS-1DD) | `Cannot read properties of null (reading 'subTree')`             | 1     | 1      | ~4h ago   | `/chat`                          | Vue teardown race; related to 1DA–1DC                                                          |
...
| [COACH-WATTS-1D9](https://newpush-y4.sentry.io/issues/COACH-WATTS-1D9) | `undefined is not an object (evaluating 't[n]')`                 | 1     | 1      | ~9h ago   | `/chat`                          | i18n / Tolgee lookup on undefined key                                                          |
...
| [COACH-WATTS-1CG](https://newpush-y4.sentry.io/issues/COACH-WATTS-1CG) | `undefined is not an object (evaluating 't.labels[0]')`          | 3     | 3      | ~22h ago  | `/workouts/:id()/map`            | Chart data missing labels                                                                      |
...
| [COACH-WATTS-66](https://newpush-y4.sentry.io/issues/COACH-WATTS-66)   | `RangeError: Maximum call stack size exceeded`                   | 6     | 22     | ~1d ago   | `/plan`                          | **High priority** — infinite recursion on plan page                                            |
...
| COACH-WATTS-3J        | Robust catch in `workouts/[id]/index.vue`                 | [resolution plan](./conductor/sentry-issues-resolution-plan.md)       |
